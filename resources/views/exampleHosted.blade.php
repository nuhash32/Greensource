...
<head>
    ...
    <title>Example - Payment | SSLCommerz</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h2>Greesource | Donation | Payment - SSLCommerz</h2>
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="mobile" value=""
                               required>
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2021 Greensource</p>
